...
""""   
#Hyperliquid exchange specific code#
min order cost = $10 // https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/error-responses

ccxt file with capabilities
https://github.com/ccxt/ccxt/blob/master/python/ccxt/hyperliquid.py




ccxt: no cancell all orders. must get all open orders, then close one at a time.

"""

def load_broker_code():
    brokerId = '' #no code for hyperliquid
    return brokerId

def load_default_type(self):
    # Adjusting the defaultType
    default_type = {
